// For reference, this game was adopted from the YouTube channel Under Ctrl. I'm adding this to gain knowledge.
...
module.exports = {
    name: 'rps',
        description: 'Simple rock paper scissors game with another user.',
        dm_permission: false,
        options: [
            {
                name: 'user',
    ...
    callback: async ( client, interaction ) => {
        try {
            ...
            if (interaction.user.id === targetUser.id) {
                interaction.reply({
                    content: `You can't play rock paper scissors alone.`,
                    ephemeral: true,
                });
            ...
            const reply = await interaction.reply({
                content: `${targetUser}, you have been challenged to Rock Paper Scissors, by ${interaction.user}. To start playing,
            ...
            .catch(async (error) => {
                embed.setDescription(`Game over. ${targetUser} did not respond in the alloted time.`);
            ...
            // Edit the embed with the updated user turn
            ...
            .catch(async (error) => {
                embed.setDescription(`Game over. ${interaction.user} did not respond in the alloted time.`);
                await reply.edit({ embed: [embed], components: [] });
            });
